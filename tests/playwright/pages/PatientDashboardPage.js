...
class PatientDashboardPage {
  constructor(page) {
    ...
    this.clinicalChartTab = page.locator('.patient-group-tab[data-patient-group="teeth"]');
    ...
    this.plansTab = page.locator('.patient-group-tab[data-patient-group="finance"]');
    this.perioTab = page.locator('.patient-group-tab[data-patient-group="teeth"]');
